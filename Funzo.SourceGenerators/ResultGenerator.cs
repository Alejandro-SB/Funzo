...
{{
    partial class {classNameWithGenericTypes} : IResult<{classSymbol.Name}, {okDisplayName},{errDisplayName}> ");
    ...
    {{");
        ...
        static {classNameWithGenericTypes} IResult<{classSymbol.Name},{okDisplayName},{errDisplayName}>.Ok({okDisplayName} ok) => {classNameWithGenericTypes}.Ok();");
            }
            else
            {
                source.Append($@"
        ...
        static {classNameWithGenericTypes} IResult<{classSymbol.Name},{okDisplayName},{errDisplayName}>.Ok({okDisplayName} ok) => {classNameWithGenericTypes}.Ok(ok);
                ");
            }
